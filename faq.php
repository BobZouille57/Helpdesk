...
<main class="container">
    ...
    <p>Connectez-vous, cliquez sur "Créer un ticket" et remplissez le formulaire.</p>

    <h3>Comment savoir si mon ticket est traité ?</h3>
    <p>Vous recevrez des réponses directement dans la page de votre ticket.</p>
